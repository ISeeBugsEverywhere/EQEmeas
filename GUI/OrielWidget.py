...
class OrielControlWidget(QtWidgets.QWidget):
    ...
    def _gui_(self):
        self.ui.goBtn.setIcon(QtGui.QIcon("GUI/Icons/play.png"))
        self.ui.connectBtn.setIcon(QtGui.QIcon("GUI/Icons/connect.png"))
        self.ui.sendCmdBtn.setIcon(QtGui.QIcon("GUI/Icons/arrow.png"))
        self.ui.entryBox.setLocale(QtCore.QLocale('c'))
        pass
