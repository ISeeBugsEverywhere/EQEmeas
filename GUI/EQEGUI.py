...
class Ui_eqeWindow(object):
    def setupUi(self, eqeWindow):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 298, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Icons/Icons/configure.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
